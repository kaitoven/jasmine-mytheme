var RENDERER = {
    ...
    this.clearTimer();
    this.tmpWidth = window.innerWidth; // 使用原生 JavaScript 获取宽度
    this.tmpHeight = window.innerHeight; // 使用原生 JavaScript 获取高度
    this.watchIds.push(setTimeout(this.jdugeToStopResize.bind(this), this.WATCH_INTERVAL));
    },
    ...
    jdugeToStopResize: function(){
        var width = window.innerWidth,  // 使用原生 JavaScript 获取窗口宽度
            height = window.innerHeight; // 使用原生 JavaScript 获取窗口高度
